...
#
# Source file:
# /home/pi/CyphalDemo/public_regulated_data_types/uavcan/si/unit/angular_acceleration/Vector3.1.0.dsdl
#
# Generated at:  2022-05-06 20:35:07.557673 UTC
# Is deprecated: no
# Fixed port ID: None
...
class Vector3_1_0:
    ...
    _MODEL_: _pydsdl_.StructureType = _restore_constant_(
        'ABzY8dxmvl0{?YXTTc@~6fRQkq9VozHIXO9n5?~Qq4=hlYO+upFua*zc4z2J+*@X6o306oJZL1DL=ujF%wOc0wpc*ANwc$a?%(;o'
        'ek=d}Q!Wi2^E543#zKc=TuB<ruhb8@LxLnqlT2z3W_e$$JkYt~pNf>jIlMT5V^}vcB&HGCU*@zI(AdeOlgCm!H16ghRfGls54oaR'
        'Cb4tC1D&Wkn0eCUD#I%fB{O$0I-i3#<&}QG37929wN}#4HP7HPOlt6-6PTHn<RKe3wn!M&lxW+nc|0LpDO!Me(2{-5c6i*?;*Gt!'
        'I^r_H2_hcrQL+iWq)J9o%N}|xw8Dhyt67$aFEt4VMZjCb{sNk55+#g-cw`=SF2Ze?vyHZ0YeGy)-(e4%B$=i$ql#Tl^b_+$w2O%6'
        '%oaXUG_X)-h;eIl#vJB(-L2G`wYs~pQExVC&1Pe(S*>nX+-kG#Hr+;bW2@G1-3r)Rxo;M*yOah}7vN2sGVw#q`0QfvaRZ2fzWxp7'
        '_FJikaPH&h2m&)rk`&C^q$F7p`AH}PFsr*fN)T4t{KwRiCsAV{XGtI=Zdx?V{XL#?EpPU_MZRF~;x+o+ZRa79vAFJpxq39rIsAfk'
        'Z|yAeaq=>WWDMS+J<z^A%-JO&nK8hdvYw^03}NT}l*R+zwsYTxiW&1nQ6_0junrCtBr&^m1Wd^ioUeokQ?q)B;>0h8IywfiBUUnG'
        '3*)Kc0o9zrskuXrEJaD0C`}}Twpk%rlB<BDA><^b$OSWJU!nAo2OX4czhiID5sIl-SX(4kr?*lGW^ubn1r6UJ%vKw@kFXQPtzxm>'
        'SU9-z*`cm6FvGyI)i!eRCUt|kH`2FLbt;ZsGHA=(RU&AHEh;M^)J#tX98SfqXbVSF2a6D{*c`5HxUUXnOvc^+mWtLU{&}QBGkEie'
        'ddoW$@A3Bm(|Ds*IDY|ADH_Gy1ONa'
    )
